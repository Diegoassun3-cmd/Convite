/**
 * Helpers de criptografia usando Web Crypto (nativo do Workers — sem
 * dependências). Senha: PBKDF2-SHA256. Sessão: cookie assinado com HMAC.
 */
...
// ------------------------------------------------------- sessão (cookie) --
async function hmac(segredo, dados) {
...
export async function criarSessaoCookie(segredo, payload, duracaoSeg) {
...
export async function lerSessaoCookie(segredo, valor) {
